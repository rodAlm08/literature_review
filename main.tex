...
\IEEEtitleabstractindextext{
    \begin{abstract}
        ...
        with clarity and transparency as opposed to "Black Box" algorithms that cannot explain how or why a particular decision was reached, outputting directly from data,
        and even their developers cannot always explain how the model arrived in such results.
    \end{abstract}
}
